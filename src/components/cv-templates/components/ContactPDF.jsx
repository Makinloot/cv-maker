    ...
    <View style={[PDFStyles.siderDetailsContainer]}>
      <View style={PDFStyles.siderDetailsTextContainer}>
        {(data.phone || data.prefix) && (
          <>
            ...
            >
              {resumeLanguage === "ge" ? "მობილური" : "Phone"}
            </Text>
      ...
      {data.email && (
        <View style={PDFStyles.siderDetailsTextContainer}>
          ...
          >
            {resumeLanguage === "ge" ? "ელ. ფოსტა" : "Email"}
          </Text>
          <Text
            style={[
              PDFStyles.siderDetailsText,
      ...
      {data?.address && (
        <View style={PDFStyles.siderDetailsTextContainer}>
          ...
          >
            {resumeLanguage === "ge" ? "მისამართი" : "Address"}
          </Text>
          <Text
            style={[
              PDFStyles.siderDetailsText,
      ...
      {data.dateOfBirth && (
        <View style={PDFStyles.siderDetailsTextContainer}>
          ...
          >
            {resumeLanguage === "ge" ? "დაბადების თარიღი" : "Date of birth"}
          </Text>
          <Text
            style={[
              PDFStyles.siderDetailsText,
      ...
      {data.placeOfBirth && (
        <View style={PDFStyles.siderDetailsTextContainer}>
          ...
          >
            {resumeLanguage === "ge" ? "დაბადების ადგილი" : "Place of birth"}
          </Text>
          <Text
            style={[
              PDFStyles.siderDetailsText,
        ...
        <View style={PDFStyles.siderDetailsTextContainer}>
          ...
          >
            {resumeLanguage === "ge" &&
              data.gender === "Female" &&
              "მდედრობითი"}
            {resumeLanguage === "ge" && data.gender === "Male" && "მამრობითი"}
